...
Таким образом, мы создаем глубокую копию связного списка со случайными указателями, сохраняя соответствие между оригинальными и скопированными узлами.
Ключевые моменты:
...
Данное решение имеет линейную временную сложность O(n), так как мы проходим по списку дважды, и линейную пространственную сложность O(n), так как мы используем словарь для хранения копий узлов.
